...
public class HelloServiceSoapBindingSkeleton implements com.m2i.formation.jsf.managedBeans.HelloService, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    static {
        ...
        _oper = new org.apache.axis.description.OperationDesc("getById", _params, new javax.xml.namespace.QName("http://managedBeans.jsf.formation.m2i.com", "getByIdReturn"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://managedBeans.jsf.formation.m2i.com", "BookBean"));
        _oper.setElementQName(new javax.xml.namespace.QName("http://managedBeans.jsf.formation.m2i.com", "getById"));
        _oper.setSoapAction("");
        _myOperationsList.add(_oper);
    ...
    {
        com.m2i.formation.jsf.managedBeans.BookBean ret = impl.getById(id);
        return ret;
    }
    ...
    {
        com.m2i.formation.jsf.managedBeans.BookBean ret = impl.getBook(id, title, price);
        return ret;
    }
