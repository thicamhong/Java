...
(function () {
    ...
    var app = angular.module('PhonecatApp', ['phonecatFilters', "phonecatAnimations"]);
    ...
    app.controller('PhoneController', 
                    function () {
                        // phone 
                        this.phone = nexus;
                        // L'image par defaut est l'image 0
                        ...
                        Soit on utilise this/phone comme la fonction a acces aux donnees. Pb : si la fct est dans un autre controller, comment faire ...
                        Soit solution propre : mettre en param un controller
                        */
                        this.postPhone = function (c) {
                            alert("your GSM (" + c.phone.id + ") is " + c.phone.name
                                 + "\n Email editor : " + c.email);
                        };
