(function () {
    ...
    app.controller('PhoneController',['$http', '$routeParams',
                    function ($http, $routeParams) {
                        ...
                        */
                        ...
                        // On recupere les donnees dans 'phones/' + $routeParams.phoneId + '.json'
                        // On fait un callback success dessus
                        // $routeParams recupere les parametres qui sont dans la table de mapping
                        $http.get('phones/' + $routeParams.phoneId + '.json').success(function (data) {
                            c.phone = data;

                            // L'image par defaut est l'image 0 du phone
